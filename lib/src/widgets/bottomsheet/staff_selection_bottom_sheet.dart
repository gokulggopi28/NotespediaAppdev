...
Future<dynamic> staffSelectionBottomSheet(BuildContext context) {
              ...
              child: Obx(() {
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return Material(
                      color: stController.selectedStaffPublisherIndex.value ==
                              index
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          if (nSController.isInternetConnected.isTrue) {
                            stController.onStaffPublisherSelection(index);
                            final currentStaffId =
                                stController.staffPublishersList[index].staffId;
                            final indexId = stController
                                .findPositionByStaffId(currentStaffId);
                            stController.onStaffPublisherSelection(indexId);
                          } else {
                        ...
                        child: ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              stController.staffPublishersList[index].staffName,
